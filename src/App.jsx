...
function App() {
  ...
  const btnStyle =
    "text-[#1900FF] back-white w-full hover:bg-[#1900FF] font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded text-center block";
  ...
  return (
    ...
    >
      <div className="p-5">
        <h1 style={{ fontSize: "2rem", color: "#1900FF" }} className="!m-5">
          salmonpls!
        </h1>
      ...
      <div className="flex flex-col items-center gap-4 p-5 w-[calc(100%-50px)] max-w-[600px] mx-auto">
        ...
        <div ref={anchorRef} className="h-[100px] w-full invisible bg-transparent"></div>
